...
export type TreatmentCreateInput =
  components["schemas"]["PostV1TreatmentsRequestBody"];

export type TreatmentUpdateInput =
  components["schemas"]["PatchV1TreatmentsByIdTreatmentIdRequestBody"];

export type TreatmentCreateResponse =
  components["schemas"]["PostV1TreatmentsPositiveResponse"]["data"];

export type TreatmentUpdateResponse =
  components["schemas"]["PatchV1TreatmentsByIdTreatmentIdPositiveResponse"]["data"];
...
export function treatmentsApi(client: FetchClient) {
  return {
    ...
    ): Promise<TreatmentCreateResponse> {
