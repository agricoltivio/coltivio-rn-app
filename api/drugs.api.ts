...
export type Drug = components["schemas"]["GetV1DrugsPositiveResponse"]["data"]["result"][number];

export type DrugDetail = components["schemas"]["GetV1DrugsByIdDrugIdPositiveResponse"]["data"];

export type DrugCreateInput = components["schemas"]["PostV1DrugsRequestBody"];

export type DrugUpdateInput = components["schemas"]["PatchV1DrugsByIdDrugIdRequestBody"];

export type DrugCreateResponse = components["schemas"]["PostV1DrugsPositiveResponse"]["data"];

export type DrugUpdateResponse = components["schemas"]["PatchV1DrugsByIdDrugIdPositiveResponse"]["data"];

export type DrugInUseResponse = components["schemas"]["GetV1DrugsByIdDrugIdInUsePositiveResponse"]["data"];
...
export function drugsApi(client: FetchClient) {
  return {
    ...
    async updateDrug(drugId: string, input: DrugUpdateInput): Promise<DrugUpdateResponse> {
