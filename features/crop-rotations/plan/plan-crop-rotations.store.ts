...
export const usePlanCropRotationsStore = create<PlanCropRotationsStore>(
  (set, get) => ({
    plotPlans: [],
          ...
          return {
            ...
            recurrence: apiRecurrence
              ? {
                  ...
                  until: apiRecurrence.until
                    ? new Date(apiRecurrence.until)
                    : undefined,
                }
              : undefined,
          };
